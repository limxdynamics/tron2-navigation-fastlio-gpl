...
<div align="center"><img src="https://raw.githubusercontent.com/Smart-Wheelchair-RRC/FAST_LIO_LOCALIZATION2/f04974907c8da976dd0495b272d18ac4c534d41f/doc/demo.GIF" width=90% /></div>

- Eliminate the accumulative error of the odometry.

<div align="center"><img src="https://raw.githubusercontent.com/Smart-Wheelchair-RRC/FAST_LIO_LOCALIZATION2/f04974907c8da976dd0495b272d18ac4c534d41f/doc/demo_accu.GIF" width=90% /></div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/Smart-Wheelchair-RRC/FAST_LIO_LOCALIZATION2/f04974907c8da976dd0495b272d18ac4c534d41f/doc/demo_init.GIF" width=49.6% />
<img src="https://raw.githubusercontent.com/Smart-Wheelchair-RRC/FAST_LIO_LOCALIZATION2/f04974907c8da976dd0495b272d18ac4c534d41f/doc/demo_init_2.GIF" width = 49.6% >
</div>
...
- Open3D and transforms3d from Ubuntu packages

```shell
sudo apt-get install python3-open3d python3-transforms3d
```

The localization node parses and publishes `sensor_msgs/PointCloud2` directly;
`ros2_numpy` is not required. Keep the Ubuntu NumPy version ahead of packages
installed in `/usr/local` so it remains ABI-compatible with Ubuntu Open3D.
